...
*Main* commands available:
 ...
 - /settings:
   ...
   - in a group: will redirect you to pm, with all that chat's settings.bot pic :- https://telegra.ph//file/18af72fe1abdaa4a164ab.jpg
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Humangasor")],
                                                                                   [InlineKeyboardButton(text="ADD  QUEEN YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="main gruop",
                                                                       url="https://t.me/SL_MEDIA_TECH_GRUOP")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("don't worry ♥️, I'm alive😍")
